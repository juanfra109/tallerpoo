...
namespace TallerPOO.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEmpl,NomEmpl,TelEmp,RfcEmpl,DirEmpl,TurnEmpl,Contraseña,Correo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpl,NomEmpl,TelEmp,RfcEmpl,DirEmpl,TurnEmpl,Contraseña,Correo")] Empleado empleado)
        {
