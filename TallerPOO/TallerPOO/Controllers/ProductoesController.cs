...
namespace TallerPOO.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(ProyectofarmContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProd,NomProd,PrecProd,CantProd")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProd,NomProd,PrecProd,CantProd")] Producto producto)
        {
