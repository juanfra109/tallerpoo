...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.Carrito", b =>
                {
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.DetalleEv", b =>
                {
                    ...
                    b.HasIndex(new[] { "TurnEmpl" }, "IX_detalle_ev_turn_empl");
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.Turno", b =>
                {
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.Carrito", b =>
                {
                    b.HasOne("TallerPOO.Models.dbModels.Empleado", "IdEmplNavigation")
                        .WithMany("Carritos")
                        .HasForeignKey("IdEmpl")
                        .IsRequired()
                        .HasConstraintName("FK_carrito_empleado");

                    b.HasOne("TallerPOO.Models.dbModels.Producto", "IdProdNavigation")
                        .WithMany("Carritos")
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.DetalleEv", b =>
                {
                    b.HasOne("TallerPOO.Models.dbModels.Ventum", "IdVentNavigation")
                        .WithOne("DetalleEv")
                        .HasForeignKey("TallerPOO.Models.dbModels.DetalleEv", "IdVent")
                        .IsRequired()
                        .HasConstraintName("FK_detalle_ev_venta");

                    b.HasOne("TallerPOO.Models.dbModels.Turno", "TurnEmplNavigation")
                        .WithMany("DetalleEvs")
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.Detalleap", b =>
                {
                    b.HasOne("TallerPOO.Models.dbModels.Almacen", "IdAlmNavigation")
                        .WithMany("Detalleaps")
                        .HasForeignKey("IdAlm")
                        .IsRequired()
                        .HasConstraintName("FK_detalleap_almacen");

                    b.HasOne("TallerPOO.Models.dbModels.Producto", "IdDetalleapNavigation")
                        .WithOne("Detalleap")
                        .HasForeignKey("TallerPOO.Models.dbModels.Detalleap", "IdDetalleap")
                        .IsRequired()
            ...
            modelBuilder.Entity("TallerPOO.Models.dbModels.Detalleev1", b =>
                {
                    ...
                    b.HasOne("TallerPOO.Models.dbModels.Proveedor", "IdProvNavigation")
                        .WithMany("Detalleev1s")
