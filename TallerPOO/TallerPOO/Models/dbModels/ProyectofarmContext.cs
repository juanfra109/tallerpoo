...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetalleEv>(entity =>
        {
            ...
            entity.HasOne(d => d.IdVentNavigation).WithOne(p => p.DetalleEv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_detalle_ev_venta");

            entity.HasOne(d => d.TurnEmplNavigation).WithMany(p => p.DetalleEvs)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Detalleev1>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEmplNavigation).WithMany(p => p.Detalleev1s)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_detalleev_empleado");

            entity.HasOne(d => d.IdProvNavigation).WithMany(p => p.Detalleev1s)
                .OnDelete(DeleteBehavior.ClientSetNull)
